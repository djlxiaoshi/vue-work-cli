      ...
      <div class="dialog-body">
        <el-form ref="business-details-form" :model="copyData" label-width="150px"  size="mini" :rules="rules">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="业务英文名称" prop="bename">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="kudo master host" prop="bkudo_master_host">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        bkafka_port: [
          { required: true, message: '请输入kafka连接端口', trigger: 'blur' }
        ],
        bkafka_user: [
        ...
        bhive_ip: [
          { required: true, message: '请输入hive连接ip', trigger: 'blur' }
        ],
        bhive_port: [
          { required: true, message: '请输入hive连接端口', trigger: 'blur' }
        ],
        bhive_user: [
        ...
        bimpala_ip: [
          { required: true, message: '请输入impala连接ip', trigger: 'blur' }
        ],
        bimpala_port: [
          { required: true, message: '请输入impala端口', trigger: 'blur' }
        ],
        bimpala_user: [
